...
public class DeduplicationProperties implements EnvironmentAware  {

   private static final Logger logger = LoggerFactory.getLogger(DeduplicationProperties.class);

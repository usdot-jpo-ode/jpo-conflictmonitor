...
// public class MapSequenceProcessor extends ContextualProcessor<String, ProcessedSpat, String, TimeChangeDetailsEvent> {
//     private KeyValueStore<String, SpatTimeChangeDetailAggregator> stateStore;
//     private SpatTimeChangeDetailsParameters parameters;

//     public MapSequenceProcessor(SpatTimeChangeDetailsParameters parameters) {
